...
var TwitterTokenStrategy = (function (_OAuthStrategy) {
  ...
  _createClass(TwitterTokenStrategy, [{
    ...
    value: function authenticate(req, options) {
      ...
      var token = options && options[this._oauthTokenField] || req.body && req.body[this._oauthTokenField] || req.query && req.query[this._oauthTokenField];
      var tokenSecret = options && options[this._oauthTokenSecretField] || req.body && req.body[this._oauthTokenSecretField] || req.query && req.query[this._oauthTokenSecretField];
      var userId = options && options[this._userIdField] || req.body && req.body[this._userIdField] || req.query && req.query[this._userIdField] || token && token.split('-')[0];
